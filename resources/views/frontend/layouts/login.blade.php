    ...
    <div class="center">
        ...
        <div class="login">
          <label>
            ...
            <input class="username" type="text" autocomplete="on" placeholder="Enter Email"/>
          </label>
          <label>
            <div class="fa fa-commenting"></div>
            <input class="password" type="password" autocomplete="off" placeholder="Enter Password"/>
            <button class="password-button">hide/show</button>
          </label>
        ...
        <div class="footer">Social Login</div>
      </div>
